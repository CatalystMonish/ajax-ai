...
const videoData = [
  { name: 'AJAX Overview', description: "Your bot that offers detailed insights into Ajax's history, products and future plans.", q1: 'Corporate Overview of AJAX Engineering', q2: '' },
  { name: 'AJAX Overview', description: "Your bot that offers detailed insights into Ajax's history, products and future plans.", q1: "AJAX's Digital Vision Powered by AI", q2: '' },
  { name: 'HSE Essentials', description: 'Your bot to provide expert guidance on Health, Safety, and Environmental compliance and best practices.', q1: 'How do cultural aspects influence safety practices in the Indian concrete construction industry?', q2: '' },
  { name: 'HSE Essentials', description: 'Your bot to provide expert guidance on Health, Safety, and Environmental compliance and best practices.', q1: 'What are the most common workplace hazards found in the Indian concrete construction industry?', q2: '' },
  { name: '3D Printing Basics', description: 'Your bot that provides comprehensive guidance on the fundamentals and intricacies of 3D printing.', q1: 'How would 3D printing benefit across the construction value chain in India', q2: '' },
  { name: '3D Printing Basics', description: 'Your bot that provides comprehensive guidance on the fundamentals and intricacies of 3D printing.', q1: 'Top environmental impacts of 3D CP', q2: '' },
  { name: 'Industry Insights', description: "Your AI bot offering in-depth, detailed guidance on Ajax's industrial insights.", q1: 'Overview of Indian Cement and Construction Industry', q2: '' },
  { name: 'Industry Insights', description: "Your AI bot offering in-depth, detailed guidance on Ajax's industrial insights.", q1: 'How is electric mobility shaping the future of construction equipment in India?', q2: '' },
];
