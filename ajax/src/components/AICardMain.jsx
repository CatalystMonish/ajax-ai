...
function AICardMain({ AIName, AIDescription, AIPicture, Q1, Q2, Q3, Q4 }) {
  ...
  return (
    <div className="flex p-[1.5625rem] flex-col shadow-md hover:shadow-xl  bg-card rounded-[0.625rem]  w-[31.25rem] flex-shrink-0">
      <div className="flex flex-row flex-grow">
        ...
        <div className="flex flex-col ml-[1.25rem]">
          <p className="font-pop font-semibold text-white text-[1.5625rem] mb-[0.3125rem]  max-h-[4rem]">
            {AIName}
          </p>
